  ...
  <div class="min-h-screen bg-gray-950 text-gray-100 px-4 py-10">
    <div class="max-w-3xl mx-auto space-y-8">
      ...
      <div class="flex items-center gap-4">
        ...
        />
        <div v-else class="size-14 rounded-full bg-gray-800 flex items-center justify-center ring-2 ring-gray-700">
        ...
        <template #account>
          <div class="pt-6 space-y-6">
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between px-4 py-3 rounded-xl bg-gray-900 border border-gray-800">
                <div class="flex items-center gap-3">
                  <UIcon name="i-lucide-log-out" class="size-4 text-gray-500" />
                  <span class="text-sm text-gray-300">Cerrar sesión en este dispositivo</span>
                </div>
                <UButton
                  variant="ghost"
                  color="neutral"
