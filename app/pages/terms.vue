  ...
  <UContainer class="py-12 max-w-3xl">
    <UCard>
      <div class="space-y-6 text-on-surface-dim">
        <h1 class="text-3xl font-display text-white">Terms of Service</h1>
        ...
        <section class="space-y-3">
          <h2 class="text-xl font-bold text-white">4. Prohibited Conduct</h2>
          <p>You agree not to:</p>
          <ul class="list-disc pl-5 space-y-1">
            <li>Attempt to bypass any security measures of the platform.</li>
            <li>Use the service for spamming or unauthorized commercial purposes.</li>
            <li>Harass or abuse other Game Masters or players.</li>
          </ul>
        </section>
